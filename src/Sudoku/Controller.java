...
public class Controller implements Initializable, NativeKeyListener {
    ...
    public void nativeKeyPressed(NativeKeyEvent nativeKeyEvent){
        ...
        if(nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_1 ||
                nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_2 ||
                nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_3 ||
                nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_4 ||
                nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_5 ||
                nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_6 ||
                nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_7 ||
                nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_8 ||
                nativeKeyEvent.getKeyCode() == NativeKeyEvent.VC_9) {


            for (int r = 0; r < puzzle.length; r++) {
                for (int c = 0; c < puzzle[r].length; c++) {

                    if (puzzleBoxes[r][c].isFocused()) {
...
//                                puzzleBoxes[finalR][finalC].setText(newValue.replaceAll("[^\\d]", ""));
//                            }
                                if (newValue.equals("")) {
                        ...
                        return; //stops searching when box is found
                    }
